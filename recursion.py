...
def print_item(my_list, i=0):
    ...
    print my_list[0]
    # list slicing allows recursion only on section of list not yet printed
...
def print_all_tree_data(tree):
    ...
    # recurse until you reach a tree node that does not have children
...
def list_length(my_list):
    ...
    # use recursion and indexing to count each item in list
...
def num_nodes(tree):
    ...
    for child in tree.children:
        # recurse for each child node in tree
        # if child node has children will recurse further
